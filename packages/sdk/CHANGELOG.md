...
- [#155](https://github.com/open-format/js/pull/155) [`70afa02`](https://github.com/open-format/js/commit/70afa02affe274ce9fb4a2e4b359076640c94a4d) Thanks [@tinypell3ts](https://github.com/tinypell3ts)! - This pull request introduces a new RequestFee function has been implemented into the BaseContract, which is now invoked during contract creation and reward distribution functions, aligning transaction fee handling with user activities. This is the first test to us testing our token model.
